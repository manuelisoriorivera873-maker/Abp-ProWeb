...
Route::middleware('auth')->group(function () {
    ...
    Route::post('inventarios_productos/{id}/incrementar-stock', [App\Http\Controllers\InventarioProductoController::class, 'incrementarStock'])->name('inventarios_productos.incrementarStock');